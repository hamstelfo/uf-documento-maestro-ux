# Prompt generativo auditable — Documentación de componentes UX (UNIFUTBOL) — v2.1 (con 5 patches)
...
- No duplicados: deduplicación estricta por clave de unicidad (ver más abajo).
...
## COORDENADAS PARA RECORTE (OBLIGATORIO SI ES POSIBLE) — PATCH 1 + PATCH 4
...
## CRITERIO OPERATIVO DE “INTERACTIVO” (CONFIDENCE) — PATCH 3
...
### 3) Mapa Pantalla → Controles (solo IDs) — PATCH 5
Para cada pantalla:
...
### 5) Anexo JSON (para validación automática) — PATCH 5 incluido
